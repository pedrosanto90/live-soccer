  ...
  return (
    <div className="flex min-h-svh flex-col items-center justify-center gap-8 p-6">
      ...
      {showTimer ? (
        <p
          className={cn(
            'text-7xl font-medium tabular-nums tracking-tight',
      ...
      <div className="grid w-full max-w-lg grid-cols-3 items-center gap-8">
        <PublicTeamScore team={homeTeam} score={match.home_score} />
        <p className="text-center text-5xl text-muted-foreground">:</p>
...
function PublicTeamScore({
  ...
  return (
    <div className="flex flex-col items-center gap-2">
      ...
      />
      <p className="text-center text-sm font-medium">{team.short_name ?? team.name}</p>
      <p className="text-7xl font-medium tabular-nums sm:text-8xl">{score}</p>
    </div>
  )
}
